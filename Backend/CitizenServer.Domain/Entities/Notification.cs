...
namespace CitizenServer.Domain.Entities
{
    public class Notification
    {
        ...
        [Required]
        public string Type { get; set; }  // Type de notification (par exemple : "Rappel", "Alert", "Info")
        ...
        [Required]
        public string Status { get; set; }  // Statut de la notification (par exemple : "Non lu", "Lu")

        [Required]
        public string Channel { get; set; }  // Canal de la notification (par exemple : "Email", "SMS")

        public bool IsRead { get; set; }  // Indique si la notification a été lue ou non

        public Guid? RelatedEntityId { get; set; }  // Référence à l'entité liée à la notification (Dossier, Rendezvous, etc.)

        [Required]
        public string RelatedEntityType { get; set; }  // Type de l'entité liée (par exemple : "Dossier", "Rendezvous")
